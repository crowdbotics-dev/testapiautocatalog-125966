...
## Project Structure
    ...
    ├── testapiautocatalog_125966  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_125966`
...
2. Clone this repo and `cd testapiautocatalog_125966`
